...
SET
    (published_new,
        ...
        bot_account_new,
        instance_id_new,
        post_count_new,post_score_new,comment_count_new,comment_score_new
        ) = (published,
        updated,
        ap_id,
        bio,
        ...
        bot_account,
        instance_id,
        post_count,post_score,comment_count,comment_score);
...
ALTER TABLE person
    ...
    DROP COLUMN bot_account,
      DROP COLUMN   instance_id,
      DROP COLUMN   post_count,DROP COLUMN  post_score,DROP COLUMN  comment_count,DROP COLUMN  comment_score;
...
alter table person alter public_key set not null,
