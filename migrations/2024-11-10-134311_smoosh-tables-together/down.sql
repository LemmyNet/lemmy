...
ALTER TABLE community_follower
    ALTER CONSTRAINT community_follower_community_id_fkey NOT DEFERRABLE;

ALTER TABLE community_follower
    ALTER CONSTRAINT community_follower_approver_id_fkey NOT DEFERRABLE;

ALTER TABLE community_follower
    ALTER CONSTRAINT community_follower_person_id_fkey NOT DEFERRABLE;

ALTER TABLE comment_like
    ALTER CONSTRAINT comment_like_comment_id_fkey NOT DEFERRABLE;

ALTER TABLE comment_like
    ALTER CONSTRAINT comment_like_person_id_fkey NOT DEFERRABLE;

ALTER TABLE instance_block
    ALTER CONSTRAINT instance_block_instance_id_fkey NOT DEFERRABLE;

ALTER TABLE instance_block
    ALTER CONSTRAINT instance_block_person_id_fkey NOT DEFERRABLE;

ALTER TABLE person_follower
    ALTER CONSTRAINT person_follower_follower_id_fkey NOT DEFERRABLE;

ALTER TABLE person_follower
    ALTER CONSTRAINT person_follower_person_id_fkey NOT DEFERRABLE;

ALTER TABLE post_read
    ALTER CONSTRAINT post_read_person_id_fkey NOT DEFERRABLE;

ALTER TABLE post_read
    ALTER CONSTRAINT post_read_post_id_fkey NOT DEFERRABLE;
