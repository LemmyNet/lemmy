...
- Self hostable, easy to deploy.
  - Comes with [Docker](https://join-lemmy.org/docs/en/admins/install_docker.html) and [Ansible](https://join-lemmy.org/docs/en/admins/install_ansible.html).
...
- [Docker](https://join-lemmy.org/docs/en/admins/install_docker.html)
- [Ansible](https://join-lemmy.org/docs/en/admins/install_ansible.html)
