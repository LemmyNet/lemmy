...
test("Follow local community", async () => {
  ...
  expect(community.counts.local_subscribers).toBe(1);
  ...
  expect(follow.community_view.counts.local_subscribers).toBe(2);
  ...
  expect(unfollow.community_view.counts.local_subscribers).toBe(1);
});
...
test("Follow federated community", async () => {
  ...
  expect(betaCommunity.counts.local_subscribers).toBe(0);
  ...
  expect(betaCommunity?.counts.local_subscribers).toBe(1);
  ...
  expect(communityOnBeta1.community?.counts.local_subscribers).toBe(1);
  ...
  expect(communityOnBeta2.community?.counts.local_subscribers).toBe(1);
});
