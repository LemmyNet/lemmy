...
impl Crud for PrivateMessage {
  ...
  async fn read(conn: &mut DbConn, private_message_id: PrivateMessageId) -> Result<Self, Error> {
    private_message
  ...
  async fn delete(conn: &mut DbConn, pm_id: Self::IdType) -> Result<usize, Error> {
