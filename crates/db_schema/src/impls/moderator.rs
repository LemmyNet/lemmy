...
impl Crud for ModRemovePost {
  ...
  type IdType = i32;
  async fn read(pool: DbPool<'_>, from_id: i32) -> Result<Self, Error> {
    use crate::schema::mod_remove_post::dsl::mod_remove_post;
    let conn = &mut get_conn(pool).await?;
    mod_remove_post.find(from_id).first::<Self>(conn).await
  }

  async fn create(pool: DbPool<'_>, form: &ModRemovePostForm) -> Result<Self, Error> {
    use crate::schema::mod_remove_post::dsl::mod_remove_post;
    let conn = &mut get_conn(pool).await?;
...
impl Crud for ModLockPost {
  ...
  async fn create(pool: DbPool<'_>, form: &ModLockPostForm) -> Result<Self, Error> {
    use crate::schema::mod_lock_post::dsl::mod_lock_post;
    let conn = &mut get_conn(pool).await?;
...
impl Crud for ModFeaturePost {
  ...
  async fn create(pool: DbPool<'_>, form: &ModFeaturePostForm) -> Result<Self, Error> {
    use crate::schema::mod_feature_post::dsl::mod_feature_post;
    let conn = &mut get_conn(pool).await?;
...
impl Crud for ModRemoveComment {
  ...
  async fn create(pool: DbPool<'_>, form: &ModRemoveCommentForm) -> Result<Self, Error> {
    use crate::schema::mod_remove_comment::dsl::mod_remove_comment;
    let conn = &mut get_conn(pool).await?;
...
impl Crud for ModRemoveCommunity {
  ...
  async fn create(pool: DbPool<'_>, form: &ModRemoveCommunityForm) -> Result<Self, Error> {
    use crate::schema::mod_remove_community::dsl::mod_remove_community;
    let conn = &mut get_conn(pool).await?;
...
impl Crud for ModBanFromCommunity {
  ...
  async fn create(pool: DbPool<'_>, form: &ModBanFromCommunityForm) -> Result<Self, Error> {
    use crate::schema::mod_ban_from_community::dsl::mod_ban_from_community;
    let conn = &mut get_conn(pool).await?;
...
impl Crud for ModBan {
  ...
  async fn create(pool: DbPool<'_>, form: &ModBanForm) -> Result<Self, Error> {
    use crate::schema::mod_ban::dsl::mod_ban;
    let conn = &mut get_conn(pool).await?;
    insert_into(mod_ban)
      .values(form)
  ...
  async fn update(pool: DbPool<'_>, from_id: i32, form: &ModBanForm) -> Result<Self, Error> {
    use crate::schema::mod_ban::dsl::mod_ban;
    let conn = &mut get_conn(pool).await?;
...
impl Crud for ModHideCommunity {
  ...
  async fn create(pool: DbPool<'_>, form: &ModHideCommunityForm) -> Result<Self, Error> {
    use crate::schema::mod_hide_community::dsl::mod_hide_community;
    let conn = &mut get_conn(pool).await?;
...
impl Crud for ModAddCommunity {
  ...
  async fn create(pool: DbPool<'_>, form: &ModAddCommunityForm) -> Result<Self, Error> {
    use crate::schema::mod_add_community::dsl::mod_add_community;
    let conn = &mut get_conn(pool).await?;
...
impl Crud for ModTransferCommunity {
  ...
  async fn create(pool: DbPool<'_>, form: &ModTransferCommunityForm) -> Result<Self, Error> {
    use crate::schema::mod_transfer_community::dsl::mod_transfer_community;
    let conn = &mut get_conn(pool).await?;
...
impl Crud for ModAdd {
  ...
  async fn create(pool: DbPool<'_>, form: &ModAddForm) -> Result<Self, Error> {
    use crate::schema::mod_add::dsl::mod_add;
    let conn = &mut get_conn(pool).await?;
    insert_into(mod_add)
      .values(form)
  ...
  async fn update(pool: DbPool<'_>, from_id: i32, form: &ModAddForm) -> Result<Self, Error> {
    use crate::schema::mod_add::dsl::mod_add;
    let conn = &mut get_conn(pool).await?;
...
impl Crud for AdminPurgePerson {
  ...
  async fn create(pool: DbPool<'_>, form: &Self::InsertForm) -> Result<Self, Error> {
    use crate::schema::admin_purge_person::dsl::admin_purge_person;
    let conn = &mut get_conn(pool).await?;
