...
impl Crud for ModRemovePost {
  ...
  type IdType = i32;
  async fn read(conn: &mut DbConn, from_id: i32) -> Result<Self, Error> {
    use crate::schema::mod_remove_post::dsl::mod_remove_post;
    mod_remove_post.find(from_id).first::<Self>(conn).await
  }

  async fn create(conn: &mut DbConn, form: &ModRemovePostForm) -> Result<Self, Error> {
    use crate::schema::mod_remove_post::dsl::mod_remove_post;
...
impl Crud for ModLockPost {
  ...
  async fn create(conn: &mut DbConn, form: &ModLockPostForm) -> Result<Self, Error> {
    use crate::schema::mod_lock_post::dsl::mod_lock_post;
  ...
  async fn update(conn: &mut DbConn, from_id: i32, form: &ModLockPostForm) -> Result<Self, Error> {
    use crate::schema::mod_lock_post::dsl::mod_lock_post;
...
impl Crud for ModFeaturePost {
  ...
  async fn create(conn: &mut DbConn, form: &ModFeaturePostForm) -> Result<Self, Error> {
    use crate::schema::mod_feature_post::dsl::mod_feature_post;
...
impl Crud for ModRemoveComment {
  ...
  async fn create(conn: &mut DbConn, form: &ModRemoveCommentForm) -> Result<Self, Error> {
    use crate::schema::mod_remove_comment::dsl::mod_remove_comment;
...
impl Crud for ModRemoveCommunity {
  ...
  async fn create(conn: &mut DbConn, form: &ModRemoveCommunityForm) -> Result<Self, Error> {
    use crate::schema::mod_remove_community::dsl::mod_remove_community;
...
impl Crud for ModBanFromCommunity {
  ...
  async fn create(conn: &mut DbConn, form: &ModBanFromCommunityForm) -> Result<Self, Error> {
    use crate::schema::mod_ban_from_community::dsl::mod_ban_from_community;
...
impl Crud for ModBan {
  ...
  async fn create(conn: &mut DbConn, form: &ModBanForm) -> Result<Self, Error> {
    use crate::schema::mod_ban::dsl::mod_ban;
    insert_into(mod_ban)
      .values(form)
      .get_result::<Self>(conn)
  ...
  async fn update(conn: &mut DbConn, from_id: i32, form: &ModBanForm) -> Result<Self, Error> {
    use crate::schema::mod_ban::dsl::mod_ban;
...
impl Crud for ModHideCommunity {
  ...
  async fn create(conn: &mut DbConn, form: &ModHideCommunityForm) -> Result<Self, Error> {
    use crate::schema::mod_hide_community::dsl::mod_hide_community;
...
impl Crud for ModAddCommunity {
  ...
  async fn create(conn: &mut DbConn, form: &ModAddCommunityForm) -> Result<Self, Error> {
    use crate::schema::mod_add_community::dsl::mod_add_community;
...
impl Crud for ModTransferCommunity {
  ...
  async fn create(conn: &mut DbConn, form: &ModTransferCommunityForm) -> Result<Self, Error> {
    use crate::schema::mod_transfer_community::dsl::mod_transfer_community;
...
impl Crud for ModAdd {
  ...
  async fn create(conn: &mut DbConn, form: &ModAddForm) -> Result<Self, Error> {
    use crate::schema::mod_add::dsl::mod_add;
    insert_into(mod_add)
      .values(form)
      .get_result::<Self>(conn)
  ...
  async fn update(conn: &mut DbConn, from_id: i32, form: &ModAddForm) -> Result<Self, Error> {
    use crate::schema::mod_add::dsl::mod_add;
...
impl Crud for AdminPurgePerson {
  ...
  async fn update(conn: &mut DbConn, from_id: i32, form: &Self::InsertForm) -> Result<Self, Error> {
    use crate::schema::admin_purge_person::dsl::admin_purge_person;
...
mod tests {
  ...
  async fn test_crud() {
    ...
    let inserted_mod_remove_comment = ModRemoveComment::create(conn, &mod_remove_comment_form)
      .await
      .unwrap();
    let read_mod_remove_comment = ModRemoveComment::read(conn, inserted_mod_remove_comment.id)
      .await
      .unwrap();
