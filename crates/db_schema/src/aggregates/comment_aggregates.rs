...
impl CommentAggregates {
  pub async fn read(pool: DbPool<'_>, comment_id: CommentId) -> Result<Self, Error> {
  ...
  pub async fn update_hot_rank(pool: DbPool<'_>, comment_id: CommentId) -> Result<Self, Error> {
    let conn = &mut get_conn(pool).await?;
