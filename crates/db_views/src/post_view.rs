...
mod tests {
  ...
  fn test_crud() {
    ...
    let new_user = UserForm {
      ...
      actor_id: Some(Url::parse("http://example.com/post_view/1").unwrap().into()),
      bio: None,
      local: true,
      private_key: None,
      public_key: None,
    ...
    let new_community = CommunityForm {
      ...
      updated: None,
      nsfw: false,
      actor_id: Some(Url::parse("http://example.com/post_view/2").unwrap().into()),
      local: true,
      private_key: None,
      public_key: None,
      last_refreshed_at: None,
    ...
    let new_post = PostForm {
      ...
      embed_html: None,
      thumbnail_url: None,
      ap_id: Some(Url::parse("http://example.com/post_view/3").unwrap().into()),
      local: true,
      published: None,
    };
