...
pub(crate) async fn get_apub_person_http(
  ...
  let person: ApubPerson = Person::read_from_name(context.conn().await?, &user_name, true)
    .await?
    .into();
...
pub(crate) async fn get_apub_person_outbox(
  ...
  let person = Person::read_from_name(context.conn().await?, &info.user_name, false).await?;
