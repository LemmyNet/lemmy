...
#[derive(Debug, Copy, Clone, Hash, Eq, PartialEq, Default, DieselNewType)]
/// The post id.
...
#[derive(Debug, Copy, Clone, Hash, Eq, PartialEq, Default, DieselNewType, Ord, PartialOrd)]
/// The instance id.
pub struct InstanceId(pub i32);

#[derive(Debug, Copy, Clone, Hash, Eq, PartialEq, Default, DieselNewType, PartialOrd, Ord)]
...
#[repr(transparent)]
#[derive(Clone, PartialEq, Eq, Debug, Hash, AsExpression, FromSqlRow)]
