...
mod tests {
  ...
  fn test_crud() {
    ...
    let new_user = UserForm {
      ...
      actor_id: Some(
        Url::parse("http://example.com/user_aggregates/1")
          .unwrap()
          .into(),
      ),
      bio: None,
    ...
    let another_user = UserForm {
      ...
      send_notifications_to_email: false,
      actor_id: Some(
        Url::parse("http://example.com/user_aggregates/2")
          .unwrap()
          .into(),
      ),
      bio: None,
    ...
    let new_community = CommunityForm {
      ...
      updated: None,
      actor_id: Some(
        Url::parse("http://example.com/user_aggregates/3")
          .unwrap()
          .into(),
      ),
      local: true,
    ...
    let new_post = PostForm {
      ...
      thumbnail_url: None,
      ap_id: Some(
        Url::parse("http://example.com/user_aggregates/4")
          .unwrap()
          .into(),
      ),
      local: true,
    ...
    let comment_form = CommentForm {
      ...
      updated: None,
      ap_id: Some(
        Url::parse("http://example.com/user_aggregates/5")
          .unwrap()
          .into(),
      ),
      local: true,
    ...
    let mut child_comment_form = CommentForm {
      ...
      updated: None,
      ap_id: Some(
        Url::parse("http://example.com/user_aggregates/6")
          .unwrap()
          .into(),
      ),
      local: true,
