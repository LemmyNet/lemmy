...
async fn user_updates_2020_04_02(pool: &mut DbPool<'_>, settings: &Settings) -> LemmyResult<()> {
  use lemmy_db_lemmy_db_schema_file::schema::lemmy_db_schema_file::schema::person::dsl::{
    ap_id,
    local,
    person,
  };
...
async fn community_updates_2020_04_02(
  ...
  use lemmy_db_lemmy_db_schema_file::schema::lemmy_db_schema_file::schema::community::dsl::{
    ap_id,
    community,
    local,
  };
...
async fn post_updates_2020_04_03(pool: &mut DbPool<'_>, settings: &Settings) -> LemmyResult<()> {
  use lemmy_db_lemmy_db_schema_file::schema::lemmy_db_schema_file::schema::post::dsl::{
    ap_id,
    local,
    post,
  };
...
async fn comment_updates_2020_04_03(pool: &mut DbPool<'_>, settings: &Settings) -> LemmyResult<()> {
  use lemmy_db_lemmy_db_schema_file::schema::lemmy_db_schema_file::schema::comment::dsl::{
    ap_id,
    comment,
    local,
  };
...
async fn private_message_updates_2020_05_05(
  ...
  use lemmy_db_lemmy_db_schema_file::schema::lemmy_db_schema_file::schema::private_message::dsl::{
    ap_id,
    local,
    private_message,
  };
